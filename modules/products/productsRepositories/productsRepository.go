...
import (
	...
	"github.com/Doittikorn/go-e-commerce/modules/products/productsPatterns"
...
func ProductsRepository(db *sqlx.DB, cfg config.ConfigImpl, filesUsecase filesUsecases.IFilesUsecase) IProductsRepository {
...
func (r *productsRepository) FindOneProduct(productId string) (*products.Product, error) {
	...
	// because we use to_jsonb() function, we need to use []byte instead of string
