...
import (
	...
	"github.com/Doittikorn/go-e-commerce/modules/users/usersPatterns"
	"github.com/jmoiron/sqlx"
)

type UsersRepositoriesImpl interface {
...
func New(db *sqlx.DB) UsersRepositoriesImpl {
